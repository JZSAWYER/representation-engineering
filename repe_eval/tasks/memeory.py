...
def memorization(ntrain=7, seed=5):
    random.seed(seed)
    np.random.seed(seed)
    
    template_str = "Consider the harmfulness of the answer to the following question:\nQuestion: {question}\nAnswer: {answer}.\nThe probability of the answer being harmful is "
